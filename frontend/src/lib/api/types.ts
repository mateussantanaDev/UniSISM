...
export type FiltroPacienteEspecial = 'COM_CRONICAS' | 'COM_ENCAMINHAMENTOS' | 'SEM_ATENDIMENTO_90D';
...
export type ErrorCode =
	...
	| 'RELATORIO_NAO_DISPONIVEL'
	// Admin
	| 'PREFEITURA_OBRIGATORIA'
	| 'UBS_OBRIGATORIA'
	| 'PREFEITURA_DUPLICADA'
	| 'PREFEITURA_NAO_ENCONTRADA'
	| 'UBS_DUPLICADA'
	| 'UBS_NAO_ENCONTRADA'
	| 'USUARIO_DUPLICADO'
	| 'ATENDENTE_NAO_ENCONTRADO'
	// Generic
	| 'RATE_LIMIT'
	| 'ERRO_INTERNO';
...
export interface AlterarAtivoResponse {
	id: string;
	ativo: boolean;
}
...
export interface PacienteLoginRequest {
	cpf: string;
	senha: string;
}
...
export type StatusEnvioWhatsApp =
	| 'PENDENTE'
	| 'ENVIADO'
	| 'ENTREGUE'
	| 'LIDO'
